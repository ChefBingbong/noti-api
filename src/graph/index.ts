...
export const getGraphUrl = (networkId: number) => {
  let graphUrl = "https://api.thegraph.com/sungraphs/name/chef-huan/user-position-v3-eth";
  switch (networkId) {
    case 1:
      graphUrl = "https://api.thegraph.com/sungraphs/name/chef-huan/user-position-v3-eth";
      break;
    case 56:
      graphUrl = "https://api.thegraph.com/subgraphs/name/chef-huan/user-position-v3-bsc";
      break;
    case 5:
